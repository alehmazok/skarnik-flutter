...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.AnalyticsAppRepository>(
      () => _i4.FirebaseAnalyticsAppRepository(),
      registerFor: {_prod},
    );
    gh.factory<_i3.AnalyticsAppRepository>(
      () => _i5.DevAnalyticsAppRepository(),
      registerFor: {_dev},
    );
    ...
    gh.factory<_i13.PrimaryTranslationRepository>(
        () => _i29.ApiTranslationRepository(gh<_i11.Dio>()));
    gh.factory<_i30.RemoveFromFavoritesUseCase>(
        () => _i30.RemoveFromFavoritesUseCase(gh<_i15.FavoritesRepository>()));
    gh.factory<_i31.SaveToHistoryUseCase>(
        () => _i31.SaveToHistoryUseCase(gh<_i20.HistoryRepository>()));
    gh.factory<_i32.SearchRepository>(
        () => _i33.ObjectboxSearchRepository(gh<_i17.ObjectboxStoreHolder>()));
    gh.factory<_i34.SearchUseCase>(
        () => _i34.SearchUseCase(gh<_i32.SearchRepository>()));
    gh.factory<_i35.SettingsHistoryRepository>(() =>
        _i36.ObjectboxSettingsHistoryRepository(
            gh<_i17.ObjectboxStoreHolder>()));
    gh.factory<_i37.VocabularyRepository>(() =>
        _i38.ObjectboxVocabularyRepository(gh<_i17.ObjectboxStoreHolder>()));
    gh.factory<_i39.WordRepository>(
        () => _i40.ObjectboxWordRepository(gh<_i17.ObjectboxStoreHolder>()));
    gh.factory<_i41.AddToFavoritesUseCase>(
        () => _i41.AddToFavoritesUseCase(gh<_i15.FavoritesRepository>()));
    gh.factory<_i42.CheckInFavoritesUseCase>(
        () => _i42.CheckInFavoritesUseCase(gh<_i15.FavoritesRepository>()));
    gh.factory<_i43.ClearHistoryUseCase>(
        () => _i43.ClearHistoryUseCase(gh<_i35.SettingsHistoryRepository>()));
    gh.factory<_i44.GetTranslationUseCase>(() => _i44.GetTranslationUseCase(
          gh<_i13.PrimaryTranslationRepository>(),
          gh<_i13.FallbackTranslationRepository>(),
        ));
    gh.factory<_i45.GetWordUseCase>(
        () => _i45.GetWordUseCase(gh<_i39.WordRepository>()));
    gh.factory<_i46.LoadVocabularyUseCase>(
        () => _i46.LoadVocabularyUseCase(gh<_i37.VocabularyRepository>()));
    return this;
  }
}
