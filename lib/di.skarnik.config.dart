...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i20.InitDatabaseUseCase>(
        () => _i20.InitDatabaseUseCase(gh<_i9.DatabaseRepository>()));
    gh.factory<_i21.InitRemoteConfigUseCase>(
        () => _i21.InitRemoteConfigUseCase());
    gh.factory<_i22.LoadHistoryUseCase>(
        () => _i22.LoadHistoryUseCase(gh<_i18.HistoryRepository>()));
    gh.factory<_i23.LogAnalyticsAppOpenUseCase>(() =>
        _i23.LogAnalyticsAppOpenUseCase(gh<_i3.AnalyticsAppRepository>()));
    gh.factory<_i24.LogAnalyticsShareUseCase>(() =>
        _i24.LogAnalyticsShareUseCase(
            gh<_i6.AnalyticsTranslationRepository>()));
    gh.factory<_i25.LogAnalyticsTranslationUseCase>(() =>
        _i25.LogAnalyticsTranslationUseCase(
            gh<_i6.AnalyticsTranslationRepository>()));
    gh.factory<_i26.SaveToHistoryUseCase>(
        () => _i26.SaveToHistoryUseCase(gh<_i15.HistoryRepository>()));
    gh.factory<_i27.SearchRepository>(
        () => _i28.ObjectboxSearchRepository(gh<_i17.ObjectboxService>()));
    gh.factory<_i29.SearchUseCase>(
        () => _i29.SearchUseCase(gh<_i27.SearchRepository>()));
    gh.factory<_i30.TranslationRepository>(
        () => _i31.SkarnikTranslationRepository(gh<_i11.Dio>()));
    gh.factory<_i32.WordRepository>(
        () => _i33.ObjectboxWordRepository(gh<_i17.ObjectboxService>()));
    gh.factory<_i34.GetTranslationUseCase>(
        () => _i34.GetTranslationUseCase(gh<_i30.TranslationRepository>()));
    gh.factory<_i35.GetWordUseCase>(
        () => _i35.GetWordUseCase(gh<_i32.WordRepository>()));
    return this;
  }
}
