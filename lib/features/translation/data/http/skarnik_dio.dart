...
class SkarnikDio extends DioForNative implements Dio {
  ...
  //   if (sdkInt < 26) {
  //     (httpClientAdapter as IOHttpClientAdapter).validateCertificate = (cert, host, port) => false;
  //   }
  // }
  ...
  void _initInterceptors() {
    interceptors.addAll([
      ...
      if (kDebugMode)
        PrettyDioLogger(requestHeader: true, requestBody: true, responseHeader: true, responseBody: false),
    ]);
  }
}
